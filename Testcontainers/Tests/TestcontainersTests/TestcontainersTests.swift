...
final class TestContainersTests: XCTestCase {
    ...
    func test_createDockerImage_shouldBeSuccess() throws {
        let expectation = expectation(description: "test_createDockerImage_shouldBeSuccess")
    ...
    func test_startDockerImage_shouldBeSuccess() throws {
        ...
        container.create { [weak self] in
            self?.container.start { host in
